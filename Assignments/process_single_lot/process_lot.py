...
if __name__ == '__main__':
     ...
     xmlFile = '2013-02-28_18_05_44.xml'
     
     imageFile = '2013-02-28_18_05_44.jpeg'
     ...
     for i in range(0,len(spaceCoordinates),4):
         ...
         x3 = spaceCoordinates[i+1][0]
         y3 = spaceCoordinates[i+1][1]
...
#         print (x1)
#         cropped = img[y3:y3+55, x3:x3+32]
#         cv.imshow('Draw01',cropped)
#         cv.waitKey(0)
